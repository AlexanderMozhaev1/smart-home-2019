...
public class EventLightOffTest {

    @Test
    public void LightOffRunOff() {
        ...
        EventLightOff eventLightOff = new EventLightOff();
        eventLightOff.eventRun("light1",smartHome);
